...
# load and split a training set and a test set

bunch = load_files('Topics')
#y_train, y_test = data_train.target, data_test.target
X_train_a, X_test_a = train_test_split(bunch.data, test_size=0.25)
y = bunch.target
#y.ravel()
#y = np.array([y])
#data_train_size_mb = size_mb(X_train.data)
...
#y_test = y_test.reshape(y_test.shape[0],1)
duration = time() - t0
#print("done in %fs at %0.3fMB/s" % (duration, data_test_size_mb / l duration))
...
print('=' * 80)
print(" Muiltinomial Naive Bayes")
